...
ci_no_pain <- t.test(GroupCohension_TOT ~ condition, data = analysis_data, subset = (condition == "no-pain"))$conf.int
ci_pain <- t.test(GroupCohension_TOT ~ condition, data = analysis_data, subset = (condition == "pain"))$conf.int
